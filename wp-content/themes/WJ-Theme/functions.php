...
/************* STUFF ADDED BY MATCHBOX *****************/

// ADD CUSTOM CSS TO STYLE CUSTOM FIELDS
add_action('admin_head', 'custom_dashboard_css');

function custom_dashboard_css() {
  echo '<link rel="stylesheet" href="'.get_stylesheet_directory_uri().'/library/css/dashboard.css" type="text/css" media="all">';
}
...
// ADD SVG TO WP FILE UPLOAD OPTIONS
